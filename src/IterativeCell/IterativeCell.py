...
class IterativeCell(tf.nn.rnn_cell.RNNCell):
    ...
    def update_iteration_activations(self, new_iteration_activations):
        ...
        batch_iteration_activations_extended = array_ops.concat(1, [batch_iteration_activations, batch_iteration_activations]) #TODO: change to extend vector or concat as function of state size
